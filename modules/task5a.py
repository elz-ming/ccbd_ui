...
def query_task5a_data(collection):
    """Query MongoDB to retrieve data for task-5a."""
    document = collection.find_one({"file_name": "task5a"})  # Query by file_name
    if not document:
